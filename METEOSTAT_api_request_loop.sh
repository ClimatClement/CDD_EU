...
/home/cl-ment-devenet/miniforge3/bin/activate CDD_EU
...
#mkdir /home/climatclement/bdd/METEOSTAT
    ...
    for ((i=0; i<num_stations; i++)); do
        ...
        for ((j=0; j<num_years; j++)); do
            ...
            curl -K "temp_${id}${year0}${year1}.txt" -o "/media/cl-ment-devenet/Partage/bdd/METEOSTAT/${name}_station_${year0}_${year1}.json"
